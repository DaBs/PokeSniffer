...
},{"vue":10,"vue-hot-reload-api":8}],13:[function(require,module,exports){
'use strict';
...
var CordovaApp = function () {
  ...
  _createClass(CordovaApp, [{
    ...
    key: 'backgroundScan',
    value: function backgroundScan() {
      var location = JSON.parse(window.localStorage.getItem("lastKnownLocation"));
      _superagent2.default.get(this.config.queryUrl + "/" + location.latitude + "/" + location.longitude).end(function (err, res) {
        if (err) return console.log(err);
        console.log(res);
        (0, _zeptoBrowserify.$)('#console').html("shit happenned");
      });
    }
  }, {
    key: 'init',
...
},{"./utils/location.js":15,"superagent":3,"zepto-browserify":11}],14:[function(require,module,exports){
'use strict';
...
var cordovaConfig = {
  queryUrl: "https://pokevision.com/map/data"
};
...
},{"./App.vue":12,"./cordova.js":13,"./utils/location.js":15,"vue":10,"vue-router":9}],15:[function(require,module,exports){
"use strict";
