...
},{"lodash.isplainobject":9}],2:[function(require,module,exports){
(function (global){
/**
...
},{"lodash._basefor":3,"lodash.isarguments":5,"lodash.keysin":10}],10:[function(require,module,exports){
/**
 * lodash 3.0.8 (Custom Build) <https://lodash.com/>
 * Build: `lodash modern modularize exports="npm" -o ./`
 * Copyright 2012-2015 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash.isarguments":5,"lodash.isarray":6}],11:[function(require,module,exports){
/**
 * lodash (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="npm" -o ./`
 * Copyright jQuery Foundation and other contributors <https://jquery.org/>
...
},{"lodash._baseclone":2,"lodash._root":4,"lodash.isplainobject":12,"lodash.keysin":13,"lodash.rest":14}],12:[function(require,module,exports){
/**
...
module.exports = exports['default'];
},{"flux-standard-action":1}],25:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./handleAction":24,"./ownKeys":27,"reduce-reducers":22}],26:[function(require,module,exports){
'use strict';
...
},{"./createAction":23,"./handleAction":24,"./handleActions":25}],27:[function(require,module,exports){
'use strict';
...
},{"lodash.isarray":31,"lodash.isobject":8,"lodash.merge":11}],31:[function(require,module,exports){
/**
...
},{"./constants":33,"redux-actions":26}],33:[function(require,module,exports){
'use strict';
...
},{"./actions":32,"./constants":33,"_process":20,"lodash.isfunction":7,"lodash.isobject":8}],36:[function(require,module,exports){
'use strict';
...
},{"./constants":33,"./createLoader":34,"./createMiddleware":35,"./reducer":37}],37:[function(require,module,exports){
'use strict';
...
},{"./constants":33,"redux-storage-merger-simple":30}],38:[function(require,module,exports){
'use strict';
...
},{"./createStore":42,"./utils/warning":44,"_process":20,"lodash/isPlainObject":18}],41:[function(require,module,exports){
"use strict";
...
},{"lodash/isPlainObject":18,"symbol-observable":50}],43:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./applyMiddleware":38,"./bindActionCreators":39,"./combineReducers":40,"./compose":41,"./createStore":42,"./utils/warning":44,"_process":20}],44:[function(require,module,exports){
'use strict';
...
},{"./is-object":46,"./request":48,"./request-base":47,"emitter":49,"reduce":21}],46:[function(require,module,exports){
/**
...
},{"./reduxMixinsCreator":55}],55:[function(require,module,exports){
...
},{"redux":43}],56:[function(require,module,exports){
/*!
 * vue-router v0.7.13
 * (c) 2016 Evan You
...
},{"_process":20}],58:[function(require,module,exports){
...
var storage = _interopRequireWildcard(_reduxStorage);
...
var _reduxStorageEngineLocalstorage = require('redux-storage-engine-localstorage');

var _reduxStorageEngineLocalstorage2 = _interopRequireDefault(_reduxStorageEngineLocalstorage);

var _PokemonActions = require('./actions/PokemonActions');

var PokemonActions = _interopRequireWildcard(_PokemonActions);
...
var _PokemonList = require('./components/PokemonList.vue');
...
var engine = (0, _reduxStorageEngineLocalstorage2.default)('pokesniffer');
var middleware = storage.createMiddleware(engine);
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-427037e8", module.exports)
  } else {
...
exports.trackPokemon = trackPokemon;
exports.untrackPokemon = untrackPokemon;
exports.updateAllPokemons = updateAllPokemons;
function trackPokemon(pokemonId) {
  return {
    type: 'track-pokemon',
    pokemonId: pokemonId
  };
...
function untrackPokemon(pokemonId) {
  return {
...
exports.default = {
  ...
  computed: {
    toggled: function toggled() {
      return this.$parent.state.menu.toggled;
    }
  },

  methods: {
    toggleMenu: function toggleMenu() {
      this.$parent.actions.toggleMenu();
    }
  }
};
if (module.exports.__esModule) module.exports = module.exports.default
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-d1aabbe0", module.exports)
  } else {
...
exports.default = {
  ...
  computed: {
    ...
    pokemonName: function pokemonName() {
      var tempString = this.data.identifier.split('-')[0];
      return tempString.charAt(0).toUpperCase() + tempString.slice(1);
    },
    distance: function distance() {
      return Math.ceil(_location2.default.calculateDistance(JSON.parse(window.localStorage.getItem("lastKnownLocation")), this.data.position) * 1000);
    },
    timeUntilDespawn: function timeUntilDespawn() {
      return (0, _moment2.default)(_moment2.default.unix(this.data.expiration_time).diff((0, _moment2.default)(new Date()))).format('mm[m] ss[s]');
    }
  }
};
if (module.exports.__esModule) module.exports = module.exports.default
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-712a99b2", module.exports)
  } else {
...
var _Pokemon = require('./Pokemon.vue');
...
exports.default = {
  ...
  props: ['pokemons', 'filter', 'filterProp'],
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div>\n  <ul class=\"grid\">\n    <slot>\n      <pokemon v-for=\"pokemon in pokemons | filterBy filter in filterProp\" :data=\"pokemon\" :details=\"false\"></pokemon>\n    </slot>\n  </ul>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-7ef55918", module.exports)
  } else {
...
exports.default = {
  ...
  props: ['pokemons', 'filter', 'order']
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<ul class=\"list\">\n  <pokemon v-for=\"pokemon in pokemons | orderBy filter order\" :data=\"pokemon\" :details=\"true\" track-by=\"$index\" transition=\"item\"></pokemon>\n</ul>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-8795db20", module.exports)
  } else {
...
var CordovaApp = function () {
  function CordovaApp(config) {
    _classCallCheck(this, CordovaApp);

    this.config = config;
  }

  _createClass(CordovaApp, [{
    key: 'onGeolocationSuccess',
    value: function onGeolocationSuccess(location) {
    ...
    value: function onGeolocationFail(error) {
      console.log(error);
    }
  }, {
    key: 'onPause',
    ...
    value: function calculateDistance(pos1, pos2) {
      var R = 6371; // km
      var dLat = this.toRad(pos2.latitude - pos1.latitude);
      var dLon = this.toRad(pos2.longitude - pos1.longitude);
      var lat1 = this.toRad(pos1.latitude);
      var lat2 = this.toRad(pos2.latitude);
...
var _ScanPage = require('./pages/ScanPage.vue');

var _ScanPage2 = _interopRequireDefault(_ScanPage);

var _WishlistPage = require('./pages/WishlistPage.vue');

var _WishlistPage2 = _interopRequireDefault(_WishlistPage);

var _SettingsPage = require('./pages/SettingsPage.vue');
...
router.map({
  '/wishlist': {
    name: 'wishlist',
    component: _WishlistPage2.default
  },
  '/scanner': {
    name: 'scanner',
...
var updatePokemons = function updatePokemons(pokemons) {
  ...
  if (pokemons) {
    ...
    /*pokemons.forEach(pokemon => {
      if (router.app.state.pokemons.map(pokemon => { return pokemon.uid }).indexOf(pokemon.uid) == -1) {
        router.app.actions.addPokemon(pokemon);
      } else if (router.app.state.pokemons.map(pokemon => { return pokemon.uid }).indexOf(pokemon.uid) !== -1) {
        router.app.actions.updatePokemon(pokemon);
      }
      pokemons = pokemons.filter(pokemon2 => { return pokemon.uid !== pokemon2.uid});
      console.log(router.app.state.pokemons);
    });
    pokemons.forEach(pokemon => {
      router.app.actions.removePokemon(pokemon.uid);
    });*/
  }
};
...
curApp.init(function () {
  _superagent2.default.get("./data/pokemons.json").end(function (err, res) {
...
exports.default = {
  ...
  components: {
    PokemonList: _PokemonList2.default
  },
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-55cae2ae", module.exports)
  } else {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-699c43cf", module.exports)
  } else {
...
var _PokemonGrid = require('../components/PokemonGrid.vue');

var _PokemonGrid2 = _interopRequireDefault(_PokemonGrid);

var _Pokemon = require('../components/Pokemon.vue');
...
exports.default = {
  ...
  methods: {
    toggleTracking: function toggleTracking(pokemon) {
    ...
    isTrackingPokemon: function isTrackingPokemon(pokemon) {
      return this.$parent.state.pokemon.currentlyTracking.indexOf(pokemon.pokemonId) !== -1;
    }
  },

  computed: {
    currentlyTracking: function currentlyTracking() {
  ...
  ready: function ready() {
    ...
    _superagent2.default.get("./data/pokemons.json").end(function (err, res) {
      if (err) return console.log(err);
      var pokemons = res.body || JSON.parse(res.text);
      var parsedPokemons = Object.keys(pokemons).map(function (key) {
        var pokemon = pokemons[key];
        pokemon.pokemonId = key;
        return pokemon;
      });
      console.log(_this, parsedPokemons);
      _this.pokemons = parsedPokemons.slice(0, 151);
    });
  },


  components: {
    PokemonGrid: _PokemonGrid2.default,
    Pokemon: _Pokemon2.default
  }
};
if (module.exports.__esModule) module.exports = module.exports.default
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-7da27b71", module.exports)
  } else {
...
var _pokemon = require('./pokemon.js');
...
var initialState = { toggled: false };
  ...
  switch (action.type) {
    ...
    case 'track-pokemon':
      if (state.currentlyTracking.indexOf(action.pokemonId) == -1) {
        return Object.assign({}, state, {
          currentlyTracking: [].concat(_toConsumableArray(state.currentlyTracking), [action.pokemonId])
        });
      } else {
        return state;
      }
    case 'untrack-pokemon':
      return Object.assign({}, state, {
        currentlyTracking: state.currentlyTracking.filter(function (pokemonId) {
...
var location = function () {
  ...
  _createClass(location, null, [{
    ...
    value: function getCurrentPosition(success, error, options) {
